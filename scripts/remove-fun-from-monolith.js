...
try {
	...
	let deletedCount = 0;
	for (const key of funCalculators) {
	...
	console.log('\n✅ Все калькуляторы Развлечения успешно удалены из монолита!');

} catch (error) {
	console.error('❌ Произошла ошибка при удалении калькуляторов Развлечения из монолита:', error);
}
