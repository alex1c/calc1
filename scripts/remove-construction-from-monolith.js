...
try {
	...
	let deletedCount = 0;
	for (const key of constructionCalculators) {
	...
	console.log('\n✅ Все калькуляторы Строительство успешно удалены из монолита!');

} catch (error) {
	console.error('❌ Произошла ошибка при удалении калькуляторов Строительство из монолита:', error);
}
