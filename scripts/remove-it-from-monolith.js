...
try {
	...
	let deletedCount = 0;
	for (const key of itCalculators) {
	...
	console.log('\n✅ Все калькуляторы IT успешно удалены из монолита!');

} catch (error) {
	console.error('❌ Произошла ошибка при удалении калькуляторов IT из монолита:', error);
}
