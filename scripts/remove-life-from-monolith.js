...
// Ключи в монолите (не targetKey из page.tsx)
...
try {
	...
	let deletedCount = 0;
	for (const key of lifeCalculators) {
	...
	console.log('\n✅ Все калькуляторы Жизнь успешно удалены из монолита!');

} catch (error) {
	console.error('❌ Произошла ошибка при удалении калькуляторов Жизнь из монолита:', error);
}
