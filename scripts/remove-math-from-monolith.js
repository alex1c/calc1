...
try {
	...
	let deletedCount = 0;
	for (const key of mathCalculators) {
	...
	console.log('\n✅ Все калькуляторы Математика успешно удалены из монолита!');

} catch (error) {
	console.error('❌ Произошла ошибка при удалении калькуляторов Математика из монолита:', error);
}
