...
function translateToGerman(text) {
	const translations = {
		...
		'Быстрые и точные расчёты, поддержка основных геометрических тел, понятный интерфейс, автоматическое применение математических формул, результаты с точностью до 2 знаков после запятой.':
			'Schnelle und präzise Berechnungen, Unterstützung grundlegender geometrischer Körper, verständliche Benutzeroberfläche, automatische Anwendung mathematischer Formeln, Ergebnisse mit Genauigkeit bis zu 2 Dezimalstellen.',
		'Мгновенные расчёты с высокой точностью':
			'Sofortige Berechnungen mit hoher Genauigkeit',
		'Поддержка множества геометрических тел':
			'Unterstützung vieler geometrischer Körper',
		'Удобный интерфейс с визуальной обратной связью':
			'Benutzerfreundliche Oberfläche mit visueller Rückmeldung',
		'Адаптивный дизайн для всех устройств':
			'Responsive Design für alle Geräte',
		'Многоязычная поддержка (русский, английский, испанский, немецкий)':
			'Mehrsprachige Unterstützung (Russisch, Englisch, Spanisch, Deutsch)',
		'Не требует регистрации или установки программ':
		...
		'Убедитесь, что все значения положительные. Для сферы введите радиус, для куба - длину стороны, для цилиндра - радиус основания и высоту. Результат отображается в кубических единицах измерения.':
			'Stellen Sie sicher, dass alle Werte positiv sind. Für eine Kugel geben Sie den Radius ein, für einen Würfel die Seitenlänge, für einen Zylinder den Grundradius und die Höhe. Das Ergebnis wird in kubischen Maßeinheiten angezeigt.',
		'Важные замечания:': 'Wichtige Hinweise:',
		'Всегда используйте одинаковые единицы измерения для всех параметров':
			'Verwenden Sie immer die gleichen Maßeinheiten für alle Parameter',
		'Результат отображается в кубических единицах':
			'Das Ergebnis wird in kubischen Einheiten angezeigt',
		'Для точных расчётов используйте достаточное количество знаков после запятой':
			'Für präzise Berechnungen verwenden Sie ausreichend Dezimalstellen',
...
function translateToSpanish(text) {
	const translations = {
		...
		'Быстрые и точные расчёты, поддержка основных геометрических тел, понятный интерфейс, автоматическое применение математических формул, результаты с точностью до 2 знаков после запятой.':
			'Cálculos rápidos y precisos, soporte para cuerpos geométricos básicos, interfaz comprensible, aplicación automática de fórmulas matemáticas, resultados con precisión hasta 2 decimales.',
		'Мгновенные расчёты с высокой точностью':
			'Cálculos instantáneos con alta precisión',
		'Поддержка множества геометрических тел':
			'Soporte para muchos cuerpos geométricos',
		'Удобный интерфейс с визуальной обратной связью':
			'Interfaz conveniente con retroalimentación visual',
		'Адаптивный дизайн для всех устройств':
			'Diseño responsivo para todos los dispositivos',
		'Многоязычная поддержка (русский, английский, испанский, немецкий)':
			'Soporte multilingüe (ruso, inglés, español, alemán)',
		'Не требует регистрации или установки программ':
			'No requiere registro o instalación de programas',
		'Бесплатное использование без ограничений':
			'Uso gratuito sin restricciones',
		'Советы по использованию': 'Consejos de uso',
		'Убедитесь, что все значения положительные. Для сферы введите радиус, для куба - длину стороны, для цилиндра - радиус основания и высоту. Результат отображается в кубических единицах измерения.':
			'Asegúrese de que todos los valores sean positivos. Para una esfera ingrese el radio, para un cubo la longitud del lado, para un cilindro el radio de la base y la altura. El resultado se muestra en unidades cúbicas.',
		'Важные замечания:': 'Notas importantes:',
		'Всегда используйте одинаковые единицы измерения для всех параметров':
			'Siempre use las mismas unidades de medida para todos los parámetros',
		'Результат отображается в кубических единицах':
			'El resultado se muestra en unidades cúbicas',
		'Для точных расчётов используйте достаточное количество знаков после запятой':
			'Para cálculos precisos use suficientes decimales',
