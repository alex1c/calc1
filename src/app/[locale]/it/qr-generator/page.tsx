...
import { QrCode, Calculator, Target, Download } from 'lucide-react';
...
export async function generateMetadata({
	...
	const t = (key: string) => messages.calculators['qr-generator'].seo[key];
	...
	return {
		...
		openGraph: {
			...
			images: [
				{
					url: 'https://calc1.ru/images/qr-generator-og.jpg',
					width: 1200,
					height: 630,
					alt: t('title'),
				},
		...
		twitter: {
			...
			title: `${t('title')} | Calc1.ru`,
			description: t('description'),
			images: ['https://calc1.ru/images/qr-generator-og.jpg'],
		},
		robots: {
			index: true,
			follow: true,
...
export default async function QRGeneratorPage({
	...
	const t = await getTranslations({
		locale,
		namespace: 'calculators.qr-generator',
	});
				...
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
					<div className='text-center'>
						<div className='flex items-center justify-center mb-6'>
							<QrCode className='w-12 h-12 text-white mr-4' />
						...
						<div className='grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto'>
							<div className='bg-white/10 backdrop-blur-sm rounded-lg p-6'>
								...
								<div className='text-blue-100'>{t('hero.fast')}</div>
							</div>
							<div className='bg-white/10 backdrop-blur-sm rounded-lg p-6'>
								...
								<div className='text-blue-100'>цветов и размера</div>
							</div>
							<div className='bg-white/10 backdrop-blur-sm rounded-lg p-6'>
								...
								<div className='text-blue-100'>PNG и SVG</div>
							</div>
						</div>
					</div>
				</div>
					...
					__html: JSON.stringify({
						...
						itemListElement: [
							...
							},
							{
								...
								position: 3,
								name: t('title'),
								item: `https://calc1.ru/${locale}/it/qr-generator`,
							},
						],
					}),
				}}
