	...
	return (
		<div className='min-h-screen bg-gray-50 dark:bg-gray-900'>
			...
			<SoftwareApplicationSchema
				category='life'
				calculatorId='gas-usage'
				namespace='calculators.gas-usage.seo'
				featureKeys={['consumptionCalculation', 'costCalculation', 'multiplePurposes', 'efficiency', 'accuracy']}
				ratingValue='4.8'
				ratingCount='156'
				screenshot='https://calc1.ru/images/gas-usage-screenshot.jpg'
			/>
