...
import { PiggyBank, Calculator, Target, TrendingUp } from 'lucide-react';
...
export default async function SavingsPage({ params: { locale } }: Props) {
	const t = await getTranslations({
		locale,
		namespace: 'calculators.savings',
	});
	...
	return (
		<div className='min-h-screen bg-gray-50 dark:bg-gray-900'>
			...
			{/* Hero Section */}
			<div className='bg-gradient-to-r from-blue-600 to-green-600 dark:from-blue-800 dark:to-green-800'>
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
					<div className='text-center'>
						<div className='flex items-center justify-center mb-6'>
							<PiggyBank className='w-12 h-12 text-white mr-4' />
					...
					__html: JSON.stringify({
						...
						itemListElement: [
							...
							},
							{
								...
								position: 3,
								name: t('title'),
								item: `https://calc1.ru/${locale}/finance/savings`,
							},
						],
					}),
				}}
