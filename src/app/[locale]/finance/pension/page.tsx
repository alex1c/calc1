...
export async function generateMetadata({
	...
	const t = (key: string) => messages.calculators['pension'].seo[key];
	...
	return {
		...
		openGraph: {
			title: `${t('title')} | Calc1.ru`,
			description: t('description'),
			url: `https://calc1.ru/${locale}/finance/pension`,
			siteName: 'Calc1.ru',
			locale: locale,
			type: 'website',
			images: [
				{
					url: 'https://calc1.ru/images/pension-calculator-og.jpg',
					width: 1200,
					height: 630,
					alt: t('title'),
				},
		...
		twitter: {
			...
			title: `${t('title')} | Calc1.ru`,
			description: t('description'),
			images: ['https://calc1.ru/images/pension-calculator-og.jpg'],
		},
		robots: {
			index: true,
			follow: true,
...
export default async function PensionPage({
	...
	const t = await getTranslations({
		locale,
		namespace: 'calculators.pension',
	});

	const tSeo = await getTranslations({
		locale,
		namespace: 'calculators.pension.seo',
	});
	...
	return (
		<div className='min-h-screen bg-gray-50 dark:bg-gray-900'>
					...
					<div className='text-center'>
						...
						<div className='grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto'>
							...
							<div className='bg-white/10 backdrop-blur-sm rounded-lg p-6'>
								...
								<div className='text-blue-100'>будущего</div>
							</div>
							<div className='bg-white/10 backdrop-blur-sm rounded-lg p-6'>
			...
			<SoftwareApplicationSchema
				...
				namespace='calculators.pension.seo'
				featureKeys={['pensionCalculation', 'pointsAnalysis', 'experiencePlanning', 'accuracy']}
				ratingValue='4.9'
				ratingCount='127'
				screenshot='https://calc1.ru/images/pension-screenshot.jpg'
			/>
					...
					__html: JSON.stringify({
						...
						itemListElement: [
							...
							},
							{
								...
								position: 3,
								name: t('title'),
								item: `https://calc1.ru/${locale}/finance/pension`,
							},
						],
					}),
				}}
