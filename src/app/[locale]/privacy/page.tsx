...
export async function generateMetadata({
	...
	const t = (key: string) => {
		const privacyMessages = messages.legal?.privacy || {};
	...
	return {
		...
		alternates: {
			canonical: `https://calc1.ru/${locale}/privacy`,
			languages: {
				ru: 'https://calc1.ru/ru/privacy',
				en: 'https://calc1.ru/en/privacy',
				es: 'https://calc1.ru/es/privacy',
				de: 'https://calc1.ru/de/privacy',
			},
		},
		openGraph: {
					...
					<div className='prose prose-lg max-w-none dark:prose-invert'>
						...
						<section className='mb-8'>
							<div className='flex items-start mb-4'>
								<Database className='h-6 w-6 text-blue-600 mr-2 mt-1 flex-shrink-0' />
						...
						<section className='mb-8'>
							...
							<div className='ml-8'>
								<p className='text-gray-700 dark:text-gray-300'>
									...
									>
										{t('section3.link') || 'Политике использования файлов cookie'}
									</a>
									.
								</p>
							</div>
						...
						<section className='mb-8'>
							<div className='flex items-start mb-4'>
								<FileText className='h-6 w-6 text-blue-600 mr-2 mt-1 flex-shrink-0' />
								<h2 className='text-2xl font-semibold text-gray-900 dark:text-white'>
									{t('section4.title')}
								</h2>
							</div>
						...
						<section className='mb-8'>
							<div className='flex items-start mb-4'>
								<Lock className='h-6 w-6 text-blue-600 mr-2 mt-1 flex-shrink-0' />
								<h2 className='text-2xl font-semibold text-gray-900 dark:text-white'>
									{t('section5.title')}
								</h2>
							</div>
						...
						<section className='mb-8'>
							<div className='flex items-start mb-4'>
								<UserCheck className='h-6 w-6 text-blue-600 mr-2 mt-1 flex-shrink-0' />
								<h2 className='text-2xl font-semibold text-gray-900 dark:text-white'>
									{t('section6.title')}
								</h2>
							</div>
