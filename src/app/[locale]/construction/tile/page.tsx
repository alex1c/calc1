	...
	return (
		<div className='min-h-screen bg-gray-50 dark:bg-gray-900'>
			...
			<SoftwareApplicationSchema
				...
				calculatorId='tile'
				namespace='calculators.tile.seo'
				featureKeys={['areaCalculation', 'tileCalculation', 'packageCalculation', 'reserveCalculation', 'accuracy']}
				ratingValue='4.9'
				ratingCount='89'
				screenshot='https://calc1.ru/images/tile-screenshot.jpg'
			/>
