	...
	return (
		<div className='min-h-screen bg-gray-50 dark:bg-gray-900'>
			...
			<SoftwareApplicationSchema
				...
				calculatorId='cable-section'
				namespace='calculators.cable-section.seo'
				featureKeys={['powerCalculation', 'currentCalculation', 'voltageDrop', 'materialSupport', 'accuracy']}
				ratingValue='4.9'
				ratingCount='89'
				screenshot='https://calc1.ru/images/cable-section-screenshot.jpg'
			/>
