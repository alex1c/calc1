...
export async function generateMetadata({
	...
	return {
		...
		alternates: {
			...
			languages: generateLanguageAlternates('/construction/roofing'),
		},
		openGraph: {
			title: `${t('title')} | Calc1.ru`,
			description: t('description'),
	...
	return (
		<div className='min-h-screen bg-gray-50 dark:bg-gray-900'>
			...
			<SoftwareApplicationSchema
				...
				namespace='calculators.roofing.seo'
				featureKeys={['areaCalculation', 'roofCalculation', 'materialsCalculation', 'reserveCalculation', 'accuracy']}
				ratingValue='4.9'
				ratingCount='89'
				screenshot='https://calc1.ru/images/roofing-screenshot.jpg'
			/>
