...
export async function generateMetadata({
	...
	return {
		...
		alternates: {
			canonical: 'https://calc1.ru/construction/gas-usage',
			languages: {
				ru: 'https://calc1.ru/ru/construction/gas-usage',
				en: 'https://calc1.ru/en/construction/gas-usage',
				de: 'https://calc1.ru/de/construction/gas-usage',
				es: 'https://calc1.ru/es/construction/gas-usage',
			},
		},
		openGraph: {
			title: t('meta.title'),
			description: t('meta.description'),
			url: 'https://calc1.ru/construction/gas-usage',
			siteName: 'Calc1.ru',
			images: [
				{
