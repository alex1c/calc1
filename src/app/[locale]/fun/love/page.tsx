...
import { Users, Heart, Calculator, Zap } from 'lucide-react';
...
export async function generateMetadata({
	...
	return {
		...
		alternates: {
			canonical: `https://calc1.ru/${locale}/fun/love`,
			languages: {
				ru: 'https://calc1.ru/ru/fun/love',
				en: 'https://calc1.ru/en/fun/love',
				es: 'https://calc1.ru/es/fun/love',
				de: 'https://calc1.ru/de/fun/love',
			},
		},
		openGraph: {
			title: `${t('title')} | Calc1.ru`,
			...
			images: [
				{
					url: 'https://calc1.ru/images/love-compatibility-og.jpg',
					width: 1200,
					height: 630,
					alt: t('title'),
				},
		...
		twitter: {
			...
			title: `${t('title')} | Calc1.ru`,
			description: t('description'),
			images: ['https://calc1.ru/images/love-compatibility-og.jpg'],
		},
		robots: {
			index: true,
			follow: true,
	...
	const breadcrumbListData = {
		...
		itemListElement: [
			...
			},
			{
				...
				position: 3,
				name: t('title'),
				item: `https://calc1.ru/${locale}/fun/love`,
			},
		],
	};
	...
	return (
		<>
			...
			<div className='min-h-screen bg-gray-50 dark:bg-gray-900'>
				...
				{/* Hero Section */}
				<div className='bg-gradient-to-r from-pink-600 via-red-600 to-rose-600 dark:from-pink-800 dark:via-red-800 dark:to-rose-800'>
						...
						<div className='text-center'>
							...
							<div className='grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto'>
								...
								<div className='bg-white/10 backdrop-blur-sm rounded-lg p-6'>
									...
									<div className='text-pink-100'>Расчёт</div>
								</div>
								<div className='bg-white/10 backdrop-blur-sm rounded-lg p-6'>
									...
									<div className='text-pink-100'>Использование</div>
								</div>
							</div>
						</div>
					</div>
