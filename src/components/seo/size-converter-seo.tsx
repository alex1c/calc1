...
/**
 * SEO Content Component for Size Converter
 * Displays comprehensive information about size conversion
 */
export default function SizeConverterSEO() {
	const t = useTranslations('calculators.size-converter.seo');
