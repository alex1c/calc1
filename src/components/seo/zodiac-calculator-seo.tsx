...
export default function ZodiacCalculatorSEO() {
	const t = useTranslations('calculators.zodiacCalculator.seo');

	// Get FAQ items for structured data
	// FAQ is at root level, not inside seo
	const tRoot = useTranslations('calculators.zodiacCalculator');
		...
		<div className='space-y-12'>
			...
			{t.raw('overview.calculationExamples') &&
				...
				t.raw('overview.calculationExamples').length > 0 && (
					<section className='bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-xl shadow-lg p-8'>
			...
			<section className='prose prose-lg max-w-none'>
				...
				<ul className='space-y-3'>
					{[1, 2, 3, 4, 5].map((index) => (
						<li
							key={index}
							className='flex items-start gap-3 bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-lg p-4 border border-purple-100 dark:border-purple-800'
						>
