...
export default function CountdownSEO() {
	const t = useTranslations('calculators.countdown.seo');
				...
				<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
					...
					<div className='bg-gradient-to-r from-green-50 to-green-100 p-6 rounded-lg'>
						<h3 className='text-lg font-semibold text-green-900 mb-3'>
							{t('useCases.deadlines')}
						</h3>
						<p className='text-green-800 mb-3'>
							{t('useCases.deadlinesDesc')}
						</p>
						<ul className='text-green-700 text-sm space-y-1'>
							<li>• {t('useCases.deadlines1')}</li>
							<li>• {t('useCases.deadlines2')}</li>
							<li>• {t('useCases.deadlines3')}</li>
						</ul>
					</div>
					...
					<div className='bg-gradient-to-r from-purple-50 to-purple-100 p-6 rounded-lg'>
						...
						<ul className='text-purple-700 text-sm space-y-1'>
							<li>• {t('useCases.personal1')}</li>
							<li>• {t('useCases.personal2')}</li>
							<li>• {t('useCases.personal3')}</li>
						</ul>
					</div>
