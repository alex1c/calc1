...
/**
 * SEO Content Component for Length Converter
 * Displays comprehensive information about length conversion
 */
export default function LengthSEO() {
	const t = useTranslations('calculators.length.seo');
