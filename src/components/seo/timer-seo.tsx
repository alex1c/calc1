				...
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
					...
					<div className='bg-red-50 dark:bg-red-900/20 p-6 rounded-lg'>
						<h3 className='text-lg font-semibold text-red-900 dark:text-red-100 mb-2'>
							{t('seo.features.controls')}
						</h3>
						<p className='text-red-800 dark:text-red-200'>
							{t('seo.features.controlsDesc')}
						</p>
					</div>
				...
				<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
					<div className='bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 p-6 rounded-lg'>
						<h3 className='text-lg font-semibold text-blue-900 dark:text-blue-100 mb-3'>
							{t('seo.useCases.pomodoro')}
						</h3>
						<p className='text-blue-800 dark:text-blue-200 mb-3'>
							{t('seo.useCases.pomodoroDesc')}
						</p>
						<ul className='text-blue-700 dark:text-blue-300 text-sm space-y-1'>
							<li>• {t('seo.useCases.pomodoro1')}</li>
							<li>• {t('seo.useCases.pomodoro2')}</li>
							<li>• {t('seo.useCases.pomodoro3')}</li>
						</ul>
					</div>
					...
					<div className='bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 p-6 rounded-lg'>
						<h3 className='text-lg font-semibold text-orange-900 dark:text-orange-100 mb-3'>
							{t('seo.useCases.cooking')}
						</h3>
						<p className='text-orange-800 dark:text-orange-200 mb-3'>
							{t('seo.useCases.cookingDesc')}
						</p>
						<ul className='text-orange-700 dark:text-orange-300 text-sm space-y-1'>
							<li>• {t('seo.useCases.cooking1')}</li>
							<li>• {t('seo.useCases.cooking2')}</li>
							<li>• {t('seo.useCases.cooking3')}</li>
						</ul>
					</div>
					...
					<div className='bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-6 rounded-lg'>
						<h3 className='text-lg font-semibold text-green-900 dark:text-green-100 mb-3'>
							{t('seo.useCases.workout')}
						</h3>
						<p className='text-green-800 dark:text-green-200 mb-3'>
							{t('seo.useCases.workoutDesc')}
						</p>
						<ul className='text-green-700 dark:text-green-300 text-sm space-y-1'>
							<li>• {t('seo.useCases.workout1')}</li>
							<li>• {t('seo.useCases.workout2')}</li>
							<li>• {t('seo.useCases.workout3')}</li>
						</ul>
					</div>
					...
					<div className='bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 p-6 rounded-lg'>
						<h3 className='text-lg font-semibold text-purple-900 dark:text-purple-100 mb-3'>
							{t('seo.useCases.study')}
						</h3>
						<p className='text-purple-800 dark:text-purple-200 mb-3'>
							{t('seo.useCases.studyDesc')}
						</p>
						<ul className='text-purple-700 dark:text-purple-300 text-sm space-y-1'>
							<li>• {t('seo.useCases.study1')}</li>
							<li>• {t('seo.useCases.study2')}</li>
							<li>• {t('seo.useCases.study3')}</li>
						</ul>
					</div>
				</div>
			</motion.section>
