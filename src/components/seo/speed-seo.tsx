...
/**
 * SEO Content Component for Speed Converter
 * Displays comprehensive information about speed conversion
 */
export default function SpeedSEO() {
	const t = useTranslations('calculators.speed.seo');
