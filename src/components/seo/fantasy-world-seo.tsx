		...
		<div className='space-y-12'>
			...
			{t.raw('overview.calculationExamples') &&
				...
				t.raw('overview.calculationExamples').length > 0 && (
					<section className='bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-xl shadow-lg p-8'>
						...
						<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
							{(
								...
								<div
									key={index}
									className='bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md border border-indigo-200 dark:border-indigo-800'
								>
				...
				<ul className='space-y-3'>
					{t.raw('advantages.items') &&
						...
						(t.raw('advantages.items') as string[]).map((item, index) => (
							<li
								key={index}
								className='flex items-start gap-3 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-lg p-4 border border-indigo-100 dark:border-indigo-800'
							>
					...
					<section className='prose prose-lg max-w-none'>
						...
						<div className='space-y-4'>
							{(t.raw('facts.items') as Array<{
								...
								<div
									key={index}
									className='border-l-4 border-indigo-400 dark:border-indigo-600 pl-4 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-r-lg p-4'
								>
