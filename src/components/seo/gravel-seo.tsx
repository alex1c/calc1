...
export default function GravelSEO() {
				...
				<div>
					...
					<div className='bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg'>
						...
						<ul className='space-y-2 text-yellow-800 dark:text-yellow-200 text-sm'>
							...
							<li>
								<strong>{t('seo.calculation.reserve')}</strong>
							</li>
						</ul>
					</div>
				</div>
						...
						{[
							{
								type: 'Фундамент',
								icon: Building2,
								thickness: '0.15-0.2 м',
								description: 'Подушка под фундамент',
							},
							{
								type: 'Дорожка',
								icon: Home,
								thickness: '0.1-0.15 м',
								description: 'Садовая дорожка из щебня',
							},
							{
								type: 'Отмостка',
								icon: Square,
								thickness: '0.1-0.2 м',
								description: 'Защита фундамента от воды',
							},
							{
								type: 'Подсыпка',
								icon: Wrench,
								thickness: '0.05-0.1 м',
								description: 'Выравнивание и подсыпка',
							},
						].map((item, idx) => {
						...
						{[
							{
								fraction: '5-10 мм',
								density: '1500 кг/м³',
								usage: 'Декоративные дорожки',
							},
							{
								fraction: '10-20 мм',
								density: '1450 кг/м³',
								usage: 'Фундамент, дорожки',
							},
							{
								fraction: '20-40 мм',
								density: '1400 кг/м³',
								usage: 'Подушка, отмостка',
							},
							{
								fraction: '40-70 мм',
								density: '1350 кг/м³',
								usage: 'Подсыпка, дренаж',
							},
						].map((item, idx) => (
							<div
								key={idx}
