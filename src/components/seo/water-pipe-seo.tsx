...
import { Droplets, Calculator, Zap, Settings } from 'lucide-react';

export default function WaterPipeSEO() {
	const t = useTranslations('calculators.waterPipeCalculator');
	const tSeo = useTranslations('calculators.waterPipeCalculator.seo');
				...
				<div>
					...
					<div className='bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg'>
						...
						<ul className='space-y-2 text-yellow-800 dark:text-yellow-200 text-sm'>
							<li>
								<strong>{tSeo('calculation.diameter')}</strong>
							</li>
							<li>
								<strong>{tSeo('calculation.flow')}</strong>
							</li>
							<li>
								<strong>{tSeo('calculation.pressure')}</strong>
							</li>
						</ul>
					</div>
				</div>
				...
				<div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
					<div className='bg-yellow-50 dark:bg-yellow-900/20 p-6 rounded-lg'>
						...
						<ul className='space-y-2 text-yellow-800 dark:text-yellow-200'>
							...
							<li>• {tSeo('tips.installation.connections')}</li>
						</ul>
					</div>
					<div className='bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg'>
						...
						<ul className='space-y-2 text-blue-800 dark:text-blue-200'>
							<li>• {tSeo('tips.calculation.velocity')}</li>
							<li>• {tSeo('tips.calculation.pressure')}</li>
							<li>• {tSeo('tips.calculation.reynolds')}</li>
						</ul>
					</div>
					<div className='bg-green-50 dark:bg-green-900/20 p-6 rounded-lg'>
						...
						<ul className='space-y-2 text-green-800 dark:text-green-200'>
							<li>• {tSeo('tips.optimization.roughness')}</li>
							<li>• {tSeo('tips.optimization.length')}</li>
							<li>• {tSeo('tips.optimization.temperature')}</li>
						</ul>
					</div>
				</div>
			</motion.section>
