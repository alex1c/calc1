...
export default function AlimonySEO() {
	...
	return (
		...
		>
				...
				<div>
					...
					<div className='bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg'>
						...
						<ul className='space-y-2 text-yellow-800 dark:text-yellow-200 text-sm'>
							<li>
								<strong>{t('seo.calculation.percentage')}</strong>
							</li>
							<li>
								<strong>{t('seo.calculation.fixed')}</strong>
							</li>
							<li>
								<strong>{t('seo.calculation.mixed')}</strong>
							</li>
							<li>
								<strong>{t('seo.calculation.yearly')}</strong>
							</li>
							<li>
								<strong>{t('seo.calculation.perChild')}</strong>
							</li>
						</ul>
					</div>
				</div>
			...
			{/* Visual Chart: Alimony Rates */}
			<div className='bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6'>
				<div className='mb-4'>
					<h2 className='text-2xl font-bold text-gray-900 dark:text-white'>
						Размер алиментов по Семейному кодексу РФ
					</h2>
				</div>
				<div>
					<p className='text-gray-700 dark:text-gray-300 mb-4'>
					...
					<div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
						{[
							...
							},
							{
								...
								percentage: '50% (1/2)',
								article: 'ст. 81 СК РФ',
								description: 'Половина дохода (максимум)',
							},
						].map((item, idx) => {
			...
			{/* Visual Chart: Calculation Methods */}
			<div className='bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6'>
				<div className='mb-4'>
					<h2 className='text-2xl font-bold text-gray-900 dark:text-white'>
						Способы расчёта алиментов
					</h2>
				</div>
				<div>
					<p className='text-gray-700 dark:text-gray-300 mb-4'>
					...
					<div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
						{[
							{
								method: 'В процентах от дохода',
								icon: Percent,
								description: 'По ст. 81 СК РФ',
								usage: 'Стабильный регулярный доход',
								example: '25% на 1 ребёнка',
							},
							{
								method: 'Фиксированная сумма',
								icon: DollarSign,
								description: 'По ст. 83 СК РФ',
								usage: 'Нерегулярный доход, иностранная валюта',
								example: 'Кратная прожиточному минимуму',
							},
							{
								method: 'Смешанный вариант',
								icon: Calculator,
								description: 'По соглашению',
								usage: 'Основной доход + дополнительные расходы',
								example: 'Процент + фиксированная часть',
							},
						].map((item, idx) => {
							const Icon = item.icon;
							return (
