		...
		<div className='max-w-4xl mx-auto px-4 py-8'>
				...
				<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
					<div className='border border-gray-200 rounded-lg p-4'>
						<h3 className='text-lg font-semibold text-gray-900 mb-2'>
							{t('seo.roofTypes.single.title')}
						</h3>
						<p className='text-gray-700 text-sm'>
							{t('seo.roofTypes.single.content')}
						</p>
					</div>
					<div className='border border-gray-200 rounded-lg p-4'>
						<h3 className='text-lg font-semibold text-gray-900 mb-2'>
							{t('seo.roofTypes.gable.title')}
						</h3>
						<p className='text-gray-700 text-sm'>
							{t('seo.roofTypes.gable.content')}
						</p>
					</div>
					<div className='border border-gray-200 rounded-lg p-4'>
						<h3 className='text-lg font-semibold text-gray-900 mb-2'>
							{t('seo.roofTypes.hip.title')}
						</h3>
						<p className='text-gray-700 text-sm'>
							{t('seo.roofTypes.hip.content')}
						</p>
					</div>
					<div className='border border-gray-200 rounded-lg p-4'>
						<h3 className='text-lg font-semibold text-gray-900 mb-2'>
							{t('seo.roofTypes.mansard.title')}
						</h3>
						<p className='text-gray-700 text-sm'>
							{t('seo.roofTypes.mansard.content')}
						</p>
					</div>
				</div>
			</div>
			...
			<div className='bg-white rounded-lg shadow-lg p-6 mb-8'>
				...
				<div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
					<div className='border border-gray-200 rounded-lg p-4'>
						<h3 className='text-lg font-semibold text-gray-900 mb-2'>
							{t('seo.materials.metalTile.title')}
						</h3>
						<p className='text-gray-700 text-sm'>
							{t('seo.materials.metalTile.content')}
						</p>
					</div>
					<div className='border border-gray-200 rounded-lg p-4'>
						<h3 className='text-lg font-semibold text-gray-900 mb-2'>
							{t('seo.materials.corrugated.title')}
						</h3>
						<p className='text-gray-700 text-sm'>
							{t('seo.materials.corrugated.content')}
						</p>
					</div>
					<div className='border border-gray-200 rounded-lg p-4'>
						<h3 className='text-lg font-semibold text-gray-900 mb-2'>
							{t('seo.materials.softTile.title')}
						</h3>
						<p className='text-gray-700 text-sm'>
							{t('seo.materials.softTile.content')}
						</p>
					</div>
				</div>
			</div>
