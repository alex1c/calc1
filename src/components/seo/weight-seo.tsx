...
/**
 * SEO Content Component for Weight Converter
 * Displays comprehensive information about weight conversion
 */
export default function WeightSEO() {
	const t = useTranslations('calculators.weight.seo');
