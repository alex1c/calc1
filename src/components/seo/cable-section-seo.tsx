...
import { Cable, Calculator, Zap, Settings } from 'lucide-react';

export default function CableSectionSEO() {
	const t = useTranslations('calculators.cableSectionCalculator');
	const tSeo = useTranslations('calculators.cableSectionCalculator.seo');
				...
				<div>
					...
					<div className='bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg'>
						...
						<ul className='space-y-2 text-yellow-800 dark:text-yellow-200 text-sm'>
							...
							<li>
								<strong>{tSeo('calculation.section')}</strong>
							</li>
							<li>
								<strong>
									{tSeo('calculation.voltageDrop')}
								</strong>
							</li>
						</ul>
					</div>
				...
				<div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
					<div className='bg-yellow-50 dark:bg-yellow-900/20 p-6 rounded-lg'>
						...
						<ul className='space-y-2 text-yellow-800 dark:text-yellow-200'>
							<li>• {tSeo('tips.installation.section')}</li>
							<li>• {tSeo('tips.installation.material')}</li>
							<li>• {tSeo('tips.installation.protection')}</li>
						</ul>
					</div>
					<div className='bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg'>
						...
						<ul className='space-y-2 text-blue-800 dark:text-blue-200'>
							<li>• {tSeo('tips.calculation.voltage')}</li>
							<li>• {tSeo('tips.calculation.length')}</li>
							<li>• {tSeo('tips.calculation.powerFactor')}</li>
						</ul>
					</div>
					<div className='bg-green-50 dark:bg-green-900/20 p-6 rounded-lg'>
						...
						<ul className='space-y-2 text-green-800 dark:text-green-200'>
							<li>• {tSeo('tips.optimization.standard')}</li>
							<li>• {tSeo('tips.optimization.routing')}</li>
							<li>• {tSeo('tips.optimization.safety')}</li>
						</ul>
					</div>
				</div>
			</motion.section>
