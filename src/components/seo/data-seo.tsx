...
/**
 * SEO Content Component for Data Converter
 * Displays comprehensive information about data conversion
 */
export default function DataSEO() {
	const t = useTranslations('calculators.data-converter.seo');
