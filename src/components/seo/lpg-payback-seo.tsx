...
export default function LpgPaybackSEO() {
	...
	return (
		...
		>
				...
				<div>
					...
					<div className='bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg'>
						...
						<ul className='space-y-2 text-yellow-800 dark:text-yellow-200 text-sm'>
							<li>
								<strong>{t('seo.calculation.fuelCost')}</strong>
							</li>
							<li>
								<strong>{t('seo.calculation.gasCost')}</strong>
							</li>
							<li>
								<strong>{t('seo.calculation.savings')}</strong>
							</li>
							<li>
								<strong>{t('seo.calculation.payback')}</strong>
							</li>
							<li>
								<strong>{t('seo.calculation.monthlySavings')}</strong>
							</li>
						</ul>
					</div>
				</div>
			...
			{/* Visual Chart: Payback Period by Mileage */}
			<div className='bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6'>
				<div className='mb-4'>
					<h2 className='text-2xl font-bold text-gray-900 dark:text-white'>
						Срок окупаемости в зависимости от пробега
					</h2>
				</div>
				<div>
					<p className='text-gray-700 dark:text-gray-300 mb-4'>
						Зависимость срока окупаемости ГБО от годового пробега при разнице цен 20 ₽/л:
					</p>
					<div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
						{[
							{
								mileage: '10000 км/год',
								payback: '3-4 года',
								icon: Calendar,
								color: 'red',
							},
							{
								mileage: '15000 км/год',
								payback: '2-2.5 года',
								icon: Calendar,
								color: 'orange',
							},
							{
								mileage: '20000 км/год',
								payback: '1.5-2 года',
								icon: Calendar,
								color: 'yellow',
							},
							{
								mileage: '30000+ км/год',
								payback: '1 год',
								icon: Calendar,
								color: 'green',
							},
			...
			{/* Visual Chart: GBO Generations */}
			<div className='bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6'>
				<div className='mb-4'>
					<h2 className='text-2xl font-bold text-gray-900 dark:text-white'>
						Поколения ГБО и стоимость установки
					</h2>
				</div>
				<div>
					<p className='text-gray-700 dark:text-gray-300 mb-4'>
						Различные поколения газобаллонного оборудования и их характеристики:
					</p>
					<div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
						{[
							{
								generation: 'ГБО 4-го поколения',
								cost: '35000-50000 ₽',
								icon: Wrench,
								description: 'Классическое ГБО, распределённый впрыск газа',
								features: 'Надёжность, доступность',
							},
							{
								generation: 'ГБО 5-го поколения',
								cost: '50000-80000 ₽',
								icon: Wrench,
								description: 'Жидкий впрыск, лучшая экономичность',
								features: 'Низкий расход, плавная работа',
							},
							{
								generation: 'ГБО 6-го поколения',
								cost: '80000-120000 ₽',
								icon: Wrench,
								description: 'Современное оборудование, прямой впрыск',
								features: 'Максимальная экономия, минимальный расход',
							},
						].map((item, idx) => {
							const Icon = item.icon;
							return (
				...
				<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
					<div className='bg-green-50 dark:bg-green-900/20 p-6 rounded-lg'>
						...
						<p className='text-green-800 dark:text-green-200'>
							Точный расчёт срока окупаемости установки ГБО в месяцах и годах на основе стоимости установки и годовой экономии
						</p>
					</div>
					<div className='bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg'>
						...
						<p className='text-blue-800 dark:text-blue-200'>
							Анализ годовой и месячной экономии на топливе, а также экономии за несколько лет использования ГБО
						</p>
					</div>
					<div className='bg-purple-50 dark:bg-purple-900/20 p-6 rounded-lg'>
						...
						<p className='text-purple-800 dark:text-purple-200'>
							Сравнение стоимости топлива на 1 км и годовой стоимости бензина и газа для принятия обоснованного решения
						</p>
					</div>
					<div className='bg-orange-50 dark:bg-orange-900/20 p-6 rounded-lg'>
						...
						<p className='text-orange-800 dark:text-orange-200'>
							Высокая точность расчётов на основе актуальных цен на топливо и реальных параметров эксплуатации автомобиля
						</p>
					</div>
				</div>
			</motion.section>
			...
			>
				...
				<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
					<div className='bg-green-50 dark:bg-green-900/20 p-6 rounded-lg'>
						...
						<p className='text-green-800 dark:text-green-200'>
							Точный расчёт срока окупаемости с учётом всех параметров: стоимости установки, пробега, расходов и цен на топливо
						</p>
					</div>
					<div className='bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg'>
						<h3 className='text-lg font-semibold text-blue-900 dark:text-blue-100 mb-2'>
						...
						<p className='text-blue-800 dark:text-blue-200'>
							Детальный анализ экономии на топливе за год, месяц и несколько лет для оценки выгоды установки ГБО
						</p>
					</div>
					<div className='bg-purple-50 dark:bg-purple-900/20 p-6 rounded-lg'>
						<h3 className='text-lg font-semibold text-purple-900 dark:text-purple-100 mb-2'>
							{t('seo.advantages.decision')}
						</h3>
						<p className='text-purple-800 dark:text-purple-200'>
							Помогает принять обоснованное решение об установке ГБО на основе расчёта реальной окупаемости и экономии
						</p>
					</div>
					<div className='bg-orange-50 dark:bg-orange-900/20 p-6 rounded-lg'>
						<h3 className='text-lg font-semibold text-orange-900 dark:text-orange-100 mb-2'>
						...
						<p className='text-orange-800 dark:text-orange-200'>
							Удобный и быстрый расчёт без необходимости изучения сложных формул и выполнения расчётов вручную
						</p>
					</div>
				</div>
			</motion.section>
