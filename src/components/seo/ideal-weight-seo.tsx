...
export default function IdealWeightSEO() {
				...
				<div>
					...
					<div className='bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg'>
						...
						<ul className='space-y-2 text-yellow-800 dark:text-yellow-200 text-sm'>
							<li>
								<strong>{t('seo.calculation.broca')}</strong>
							</li>
							<li>
								<strong>{t('seo.calculation.lorentz')}</strong>
							</li>
							<li>
								<strong>{t('seo.calculation.devine')}</strong>
							</li>
							<li>
								<strong>{t('seo.calculation.hamwi')}</strong>
							</li>
							<li>
								<strong>{t('seo.calculation.robinson')}</strong>
							</li>
							<li>
								<strong>{t('seo.calculation.miller')}</strong>
							</li>
						</ul>
					</div>
					<div className='mt-4'>
						...
						<ul className='space-y-2 text-gray-700 dark:text-gray-300 text-sm'>
							<li>1. {t('seo.calculation.steps.parameters')}</li>
							<li>2. {t('seo.calculation.steps.formula')}</li>
							<li>3. {t('seo.calculation.steps.calculation')}</li>
							<li>4. {t('seo.calculation.steps.comparison')}</li>
						</ul>
					</div>
				</div>
			</div>

			{/* Visual Chart: Formulas Comparison */}
			<div className='bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6'>
				<div className='mb-4'>
					<h2 className='text-2xl font-bold text-gray-900 dark:text-white'>
						Сравнение формул для мужчины 180 см
					</h2>
				</div>
				<div>
					<p className='text-gray-700 dark:text-gray-300 mb-4'>
						Пример расчёта идеального веса разными формулами для мужчины ростом 180 см:
					</p>
						...
						{[
							...
							return (
								...
								>
									...
									<p className='font-bold text-lg'>{item.weight}</p>
								</div>
							);
						})}
					</div>
				...
				<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
					<div className='bg-green-50 dark:bg-green-900/20 p-6 rounded-lg'>
						...
						<p className='text-green-800 dark:text-green-200'>
							Точный расчёт идеального веса на основе роста, пола и возраста с
							использованием проверенных медицинских формул
						</p>
					</div>
					<div className='bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg'>
						...
						<p className='text-blue-800 dark:text-blue-200'>
							Поддержка 6 различных формул: Брока, Лоренца, Девина, Хамви,
							Робинсона и Миллера для сравнения результатов
						</p>
					</div>
					<div className='bg-purple-50 dark:bg-purple-900/20 p-6 rounded-lg'>
						...
						<p className='text-purple-800 dark:text-purple-200'>
							Персонализированные результаты с учётом пола, роста и возраста для
							точного определения идеального веса
						</p>
					</div>
					<div className='bg-orange-50 dark:bg-orange-900/20 p-6 rounded-lg'>
						...
						<p className='text-orange-800 dark:text-orange-200'>
							Высокая точность расчётов на основе проверенных медицинских формул,
			...
			>
				...
				<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
					<div className='bg-green-50 dark:bg-green-900/20 p-6 rounded-lg'>
						...
						<p className='text-green-800 dark:text-green-200'>
							Точный расчёт по проверенным медицинским формулам, используемым в
							клинической практике и диетологии
						</p>
					</div>
					<div className='bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg'>
						<h3 className='text-lg font-semibold text-blue-900 dark:text-blue-100 mb-2'>
							{t('seo.advantages.multipleFormulas')}
						</h3>
						<p className='text-blue-800 dark:text-blue-200'>
							6 различных формул для сравнения результатов и выбора наиболее
							подходящей для вашего случая
						</p>
					</div>
					<div className='bg-purple-50 dark:bg-purple-900/20 p-6 rounded-lg'>
						<h3 className='text-lg font-semibold text-purple-900 dark:text-purple-100 mb-2'>
							{t('seo.advantages.personalized')}
						</h3>
						<p className='text-purple-800 dark:text-purple-200'>
							Персонализированные результаты с учётом пола, роста и возраста для
							точного определения идеального веса
					...
					<div className='bg-orange-50 dark:bg-orange-900/20 p-6 rounded-lg'>
						...
						<p className='text-orange-800 dark:text-orange-200'>
							Удобный и быстрый расчёт без необходимости изучения сложных формул и
							выполнения расчётов вручную
						</p>
					</div>
				</div>
			</motion.section>
