...
/**
 * SEO Content Component for Energy Converter
 * Displays comprehensive information about energy conversion
 */
export default function EnergySEO() {
	const t = useTranslations('calculators.energy-converter.seo');
