...
export default function NameGeneratorSEO() {
	const t = useTranslations('calculators.nameGenerator.seo');
		...
		<div className='space-y-12'>
			...
			{t.raw('overview.calculationExamples') &&
				...
				t.raw('overview.calculationExamples').length > 0 && (
					<section className='bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl shadow-lg p-8'>
						...
						<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
							{(
								...
								<div
									key={index}
									className='bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md border border-blue-200 dark:border-blue-800'
								>
				...
				<ul className='space-y-3'>
					{t.raw('advantages.items') &&
						...
						(t.raw('advantages.items') as string[]).map((item, index) => (
							<li
								key={index}
								className='flex items-start gap-3 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg p-4 border border-blue-100 dark:border-blue-800'
							>
					...
					<section className='prose prose-lg max-w-none'>
						...
						<div className='space-y-4'>
							{(t.raw('facts.items') as Array<{
								...
								<div
									key={index}
									className='border-l-4 border-blue-400 dark:border-blue-600 pl-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-r-lg p-4'
								>
