...
export default function OsagoSEO() {
	const t = useTranslations('calculators.osago');
	const tSeo = useTranslations('calculators.osago.seo');
	...
	// Chart data for visualization - KBM impact
	const kbmImpact = [
		{
			kbm: 0.5,
			discount: 50,
					...
					<div className='mt-8 grid grid-cols-1 md:grid-cols-2 gap-6'>
						...
						<div className='bg-gray-50 dark:bg-gray-700 p-5 rounded-lg'>
							<h4 className='text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2'>
								...
								Сравнение стоимости по регионам (базовый тариф 5
								000 ₽)
							</h4>
				...
				<div className='bg-gray-50 dark:bg-gray-700 p-4 rounded-lg mt-4'>
					<ul className='list-disc list-inside space-y-2 ml-4'>
						<li className='text-gray-700 dark:text-gray-300'>
							{tSeo('coefficients.territory')}
						</li>
						<li className='text-gray-700 dark:text-gray-300'>
							{tSeo('coefficients.ageExperience')}
						</li>
						<li className='text-gray-700 dark:text-gray-300'>
							{tSeo('coefficients.power')}
						</li>
						<li className='text-gray-700 dark:text-gray-300'>
							{tSeo('coefficients.drivers')}
						</li>
						<li className='text-gray-700 dark:text-gray-300'>
							{tSeo('coefficients.bonusMalus')}
						</li>
					</ul>
				</div>
			</div>
			...
			<div className='bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 md:p-8'>
				...
				<div className='space-y-4'>
					{[
						...
						{
							key: 'bonusMalus',
							text: tSeo('tips.bonusMalus'),
							icon: TrendingUp,
						},
						{
							key: 'early',
							text: tSeo('tips.early'),
							icon: Clock,
						},
						{
							key: 'documents',
