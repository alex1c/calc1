...
import { Sparkles, Droplet, Package, Square } from 'lucide-react';

export default function PrimerSEO() {
	...
	return (
		...
		>
			...
			<div className='bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6'>
				...
				<div>
					<p className='text-gray-700 dark:text-gray-300 mb-4'>
						Основные типы грунтовки и их характеристики:
					</p>
					<div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
						{[
							{
								type: 'Акриловая грунтовка',
								icon: Droplet,
								consumption: '0.08-0.12 л/м²',
								description:
									'Универсальная, для различных поверхностей',
							},
							{
								type: 'Алкидная грунтовка',
								icon: Droplet,
								consumption: '0.1-0.15 л/м²',
								description: 'Для дерева и металла',
							},
							{
								type: 'Глубокопроникающая грунтовка',
								icon: Droplet,
								consumption: '0.1-0.15 л/м²',
								description:
									'Для рыхлых и пористых поверхностей',
							},
							{
								type: 'Грунтовка-антисептик',
								icon: Droplet,
								consumption: '0.12-0.15 л/м²',
								description: 'Против плесени и грибка',
							},
						].map((item, idx) => {
			...
			<div className='bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6'>
				...
				<div>
					<p className='text-gray-700 dark:text-gray-300 mb-4'>
						Расход грунтовки в зависимости от типа поверхности:
					</p>
					<div className='grid grid-cols-1 md:grid-cols-5 gap-4'>
						{[
							{
								surface: 'Гладкая поверхность',
								consumption: '0.08-0.1 л/м²',
								description: 'Минимальный расход',
							},
							{
								surface: 'Штукатурка',
								consumption: '0.1-0.12 л/м²',
								description: 'Стандартный расход',
							},
							{
								surface: 'Пористые материалы',
								consumption: '0.12-0.15 л/м²',
							...
							>
								<Square className='w-8 h-8 text-blue-600 dark:text-blue-400 mx-auto mb-2' />
								<h3 className='text-lg font-semibold text-gray-900 dark:text-white mb-2'>
									{item.surface}
								</h3>
								<p className='text-gray-700 dark:text-gray-300 text-sm mb-1 font-bold'>
				...
				<div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
					<div className='bg-yellow-50 dark:bg-yellow-900/20 p-6 rounded-lg'>
						...
						<ul className='space-y-2 text-yellow-800 dark:text-yellow-200'>
							...
							<li>• {t('seo.tips.preparation.drying')}</li>
						</ul>
					</div>
					<div className='bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg'>
