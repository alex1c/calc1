...
/**
 * SEO Content Component for Pressure Converter
 * Displays comprehensive information about pressure conversion
 */
export default function PressureSEO() {
	const t = useTranslations('calculators.pressure.seo');
