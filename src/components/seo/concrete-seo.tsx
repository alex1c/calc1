...
import { Square, Package, Wrench, Droplet } from 'lucide-react';

export default function ConcreteSEO() {
	...
	return (
		...
		>
				...
				<div>
					...
					<div className='bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg'>
						...
						<ul className='space-y-2 text-yellow-800 dark:text-yellow-200 text-sm'>
							<li>
								<strong>{t('seo.calculation.volume')}</strong>
							</li>
							<li>
								<strong>
									{t('seo.calculation.components')}
								</strong>
							</li>
							<li>
								<strong>{t('seo.calculation.water')}</strong>
							</li>
						</ul>
					</div>
						...
						{[
							{
								...
								icon: Wrench,
								proportions: '1:4:6',
								description: 'Для ненагруженных конструкций',
							},
							{
								grade: 'М150',
								icon: Wrench,
								proportions: '1:3:5',
								description: 'Для малонагруженных конструкций',
							},
							{
								grade: 'М200',
								icon: Wrench,
								proportions: '1:2.5:4.5',
								description: 'Для фундаментов и стен',
							},
							{
								grade: 'М250',
								icon: Wrench,
								proportions: '1:2:4',
								description: 'Для нагруженных конструкций',
							},
							{
								grade: 'М300',
								icon: Wrench,
								proportions: '1:1.5:3',
								description:
									'Для высоконагруженных конструкций',
							},
							{
								grade: 'М400',
								icon: Wrench,
							...
							return (
								<div
									key={idx}
									className='bg-gray-50 dark:bg-gray-700 p-4 rounded-lg text-center border-2 border-gray-200 dark:border-gray-600'
								>
			...
			{/* Visual Chart: Standard Proportions */}
			<div className='bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6'>
				<div className='mb-4'>
					<h2 className='text-2xl font-bold text-gray-900 dark:text-white'>
						Стандартные пропорции компонентов
					</h2>
				</div>
				<div>
					<p className='text-gray-700 dark:text-gray-300 mb-4'>
						Пропорции цемента, песка и щебня для различных марок
						бетона:
					</p>
						...
						{[
							{
								...
								icon: Package,
								ratio: '1 часть',
								description: 'Связующее вещество',
							},
							{
								component: 'Песок',
								icon: Package,
								ratio: '2-4 части',
								description: 'Мелкий заполнитель',
							},
							{
								component: 'Щебень',
								icon: Package,
								ratio: '3-6 частей',
								description: 'Крупный заполнитель',
							},
							{
								component: 'Вода',
								icon: Droplet,
								ratio: '0.4-0.7',
								description: 'В/Ц соотношение',
							},
						].map((item, idx) => {
							const Icon = item.icon;
							return (
				...
				<div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
					<div className='bg-yellow-50 dark:bg-yellow-900/20 p-6 rounded-lg'>
						...
						<ul className='space-y-2 text-yellow-800 dark:text-yellow-200'>
							<li>• {t('seo.tips.preparation.volume')}</li>
							<li>• {t('seo.tips.preparation.materials')}</li>
							<li>• {t('seo.tips.preparation.equipment')}</li>
						</ul>
					</div>
					<div className='bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg'>
						<h3 className='text-lg font-semibold text-blue-900 dark:text-blue-100 mb-4'>
							{t('seo.tips.mixing.title')}
						</h3>
						<ul className='space-y-2 text-blue-800 dark:text-blue-200'>
							<li>• {t('seo.tips.mixing.proportions')}</li>
							<li>• {t('seo.tips.mixing.water')}</li>
							<li>• {t('seo.tips.mixing.time')}</li>
						</ul>
					</div>
					<div className='bg-green-50 dark:bg-green-900/20 p-6 rounded-lg'>
						<h3 className='text-lg font-semibold text-green-900 dark:text-green-100 mb-4'>
							{t('seo.tips.quality.title')}
						</h3>
						<ul className='space-y-2 text-green-800 dark:text-green-200'>
							<li>• {t('seo.tips.quality.grade')}</li>
							<li>• {t('seo.tips.quality.components')}</li>
							<li>• {t('seo.tips.quality.control')}</li>
						</ul>
					</div>
				</div>
			</motion.section>
