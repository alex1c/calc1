...
/**
 * Car Loan Calculator Component
 * 
 * A React component for calculating car loan payments and schedules.
 * 
 * Features:
...
export default function CarLoanCalculator() {
	...
	const handleDownloadCSV = () => {
		...
		link.href = url;
		link.download = 'car-loan-schedule.csv';
		link.click();
					...
					<div className='prose prose-lg max-w-none text-gray-700 space-y-6'>
						...
						<div>
							...
							<ul className='list-disc list-inside space-y-2 ml-4'>
								...
								<li>{t('seo.advantages.lowRates')}</li>
							...
							<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
								<div className='bg-white p-4 rounded-lg border'>
									<h4 className='font-semibold text-gray-900 mb-2'>
										{t('seo.programs.newCar.title')}
									</h4>
									<p className='text-sm text-gray-600'>
										{t('seo.programs.newCar.desc')}
									</p>
								</div>
								<div className='bg-white p-4 rounded-lg border'>
									<h4 className='font-semibold text-gray-900 mb-2'>
										{t('seo.programs.usedCar.title')}
									</h4>
									<p className='text-sm text-gray-600'>
										{t('seo.programs.usedCar.desc')}
									</p>
								</div>
							</div>
						</div>
